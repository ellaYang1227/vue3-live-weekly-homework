export default {
    ...
    <ul class="pagination justify-content-center pagination-sm">
      ...
      <li class="page-item" :class="{ disabled: pagination.current_page === pagination.total_pages || pagination.has_next }"><a class="page-link" href="#" aria-label="Next" @click.prevent="switchCurrent_page(current_page + 1)">
